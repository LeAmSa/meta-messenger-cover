...
function ChatInput({ session }: ChatInputProps) {
  ...
  async function addMessage(e: FormEvent<HTMLFormElement>) {
    ...
    async function uploadMessageToUpstash() {
  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 rounded border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent px-5 py-3"
      />
      <button
        type="submit"
        disabled={!input}
